  ...
  const headerHTML = `
    <header class="sticky">
      <div class="flex h-16 justify-between p-3 landscape:md:hidden">
        <a href=".${subpage ? " ." : ""}/"> <img src=".${subpage ? " ." : ""}/images/favicon.png"
          alt="Website favicon" class="h-full rounded-xl" /> </a>
        <button type="button" title="Toggle Header Menu" id="header-menu-button">
          <i class="fa-solid fa-bars my-auto h-8"></i>
        </button>
      </div>
      <nav id="header-menu"
        class="hidden flex-col gap-3 pb-3 landscape:md:m-auto landscape:md:flex landscape:md:h-16 landscape:md:w-max landscape:md:flex-row landscape:md:justify-evenly landscape:md:gap-20 landscape:md:p-0">
        <a href=".${subpage ? "." : ""}/">HOME </a> <a href=".${subpage ? "." : ""}/aboutme">ABOUT ME</a> <a
          href=".${subpage ? "." : ""}/projects">PROJECTS </a> <a href=".${subpage ? "." : ""}/contactme">CONTACT
          ME</a>
      </nav>
    </header>
    `;
